...
model = torch.load('out/resnet_model.pth')
...
if __name__ == "__main__":
    ...
    image_path = '/Users/wushuang/PycharmProjects/ImageClassification/SplitDataset/test/002/4.jpg'
    ...
    print(name_list)
    print(name_list[predicted_class][1])
